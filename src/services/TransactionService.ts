...
export class TransactionService {
   ...
   */
  private async pollTransactionConfirmation(txHash: string, transactionId: number, userId?: number): Promise<void> {
   ...
   */
  async getTransactionHistory(address: string, network: Network, limit: number = 10): Promise<Transaction[]> {
